    ...
    items: [
        {
            ...
            '<div style="padding: 30px">' +
                ...
                '<h2>Терминология</h2><table class="helptable">' +
                    ...
                    '</table>.' +
                '<h2>Основная идея</h2>' +
                    '<p>Система для каждой своей операции над сущностью выполняет набор проверок и на основе успешности ' +
                        'прохождения этих проверок решает, выполнить ли запрошенную операцию или вывести пользователю информацию об ошибках или предупреждениях.</p>' +
            ...
            '<h3>Поля сообщений</h3>' +
                '<p><ul>' +
                    ...
                    '<li>Текст сообщения - сообщение, выводимое пользователю. Сообщения могут быть параметризованны. Для этого укажите "маячки" параметров в тексте сообщения.' +
            ...
            '<h2>Экспорт и выгрузки</h2>' +
                    'С главной страницы доступен экспорт существующих проверок в EXCEL. <br/>Если проверка используется ' +
